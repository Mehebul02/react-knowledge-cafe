...
const Blog = ({blog,handleToBookMark,handleReadMark}) => {
    ...
    return (
        <div className='mt-10'>
           ...
           <button onClick={()=>handleReadMark(id,reading_time)} className='border-b-2 border-blue-800 text-blue-800'>Mark As Read</button>
        </div>
    );
};
Blog.propTypes={
